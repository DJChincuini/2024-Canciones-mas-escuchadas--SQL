...
INSERT INTO spotify (SPOTIFY_STREAMS, SPOTIFY_PLAYLIST_COUNT, SPOTIFY_PLAYLIST_REACH, SPOTIFY_POPULARITY)
SELECT SPOTIFY_STREAMS, SPOTIFY_PLAYLIST_COUNT, SPOTIFY_PLAYLIST_REACH, SPOTIFY_POPULARITY
FROM temp_canciones;
